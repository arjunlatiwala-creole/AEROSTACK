...
const _handler = async (
	...
	const logger = createLogger("list-engagement-invitations", context);
	...
	try {
		...
		logger.info("Listing APN engagement invitations", { params });

		const result = await repo.listEngagementInvitations({
			limit: params.limit,
